...
def attack(char_name: str, char_class: str) -> str:
    """Player attacks. Damage is vary depending on player's class."""
...
def defence(char_name: str, char_class: str) -> str:
    """
    Player defends.
    Blocked damage is vary depending on player's class.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Player uses special. Special vary depending on player's class."""
    if char_class == 'warrior':
